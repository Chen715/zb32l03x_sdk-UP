...
#ifndef __ZB32L03x_HAL_H
#define __ZB32L03x_HAL_H
...
/**
 *  \brief  Force enter HardFault_Handler(), and backtrace program counter
 */
#define __HAL_FORCE_ENTER_HARD_FAULT()      \
            do { void (*pfunc)(void) = (void (*)(void))(0x00000000ul); pfunc(); } while(0)
