...
#ifndef __ZB32L03x_HAL_RTC_H
#define __ZB32L03x_HAL_RTC_H
...
typedef struct
{
    ...
    int8_t TimeTrim;            /*!< Specifies the RTC clock trimming
                                    This parameter must be a number between Min_Data = -128 and Max_Data = 127 */
    uint16_t HxtDivider;        /*!< Specifies the HXT clock divider
                                    This parameter must be a number between Min_Data = 0 and Max_Data = 0x3ff */
...
#define RTC_CLOCK_SIRC                      (0x01UL<<RTC_CLKCR_RTCCKSEL_Pos)
...
#define RTC_ALARM_ALL_ENABLE                (RTC_ALM1DATE_ALMYEAREN | RTC_ALM1DATE_ALMMONEN | RTC_ALM1DATE_ALMDAYEN | \
                                             RTC_ALM1DATE_ALMWEEKEN |                                                 \
                                             RTC_ALM1DATE_ALMHOUREN | RTC_ALM1DATE_ALMMINEN | RTC_ALM1DATE_ALMSECEN)
...
#define IS_RTC_WEEKDAY(WEEKDAY)             (((int)(WEEKDAY) >= (int)RTC_WEEKDAY_SUNDAY) && ((WEEKDAY) <= RTC_WEEKDAY_SATURDAY))
...
#define IS_RTC_CLOCK_SOURCE(SOURCE)         ((SOURCE == RTC_CLOCK_LXT) || (SOURCE == RTC_CLOCK_SIRC) || (SOURCE == RTC_CLOCK_HXT))
...
#define IS_RTC_HXT_DIVIDER(DIV)             ((DIV > (uint16_t)(0)) && (TRIM < (uint16_t)(0x3ff)))
/**
 * @}
 */
