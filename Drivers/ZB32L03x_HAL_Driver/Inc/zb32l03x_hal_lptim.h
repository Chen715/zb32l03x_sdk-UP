...
#ifndef __ZB32L03x_HAL_LPTIM_H
#define __ZB32L03x_HAL_LPTIM_H
 ...
 * @{
 */
#define LPTIM_MAXCNTVALUE_16BIT             (0x0000FFFFU)                     /*!< lptimer maxim counter value 0xFFFF */
/**
 * @}
 */
 ...
 * @{
 */
#define LPTIM_CLOCK_SOURCE_PCLK             (LPTIM_CR_TCK_SEL_PCLK << LPTIM_CR_TCK_SEL_Pos)       /*!< Specify PCLK as lptim clock source */
#define LPTIM_CLOCK_SOURCE_LXT              (LPTIM_CR_TCK_SEL_LXT  << LPTIM_CR_TCK_SEL_Pos)       /*!< Specify LXT as lptim clock source */
#define LPTIM_CLOCK_SOURCE_SIRC             (LPTIM_CR_TCK_SEL_SIRC << LPTIM_CR_TCK_SEL_Pos)       /*!< Specify SIRC as lptim clock source */
/**
 * @}
 */
